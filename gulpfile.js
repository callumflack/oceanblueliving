...
var options = {
  ...
  watch: {
    files: function() {
      return [options.images.files, options.js.files, options.sass.files];
    },
    run: function() {
      return [
        ["images"],
...
gulp.task("psiMobile", function() {
  return plugins
    .psi(options.pagespeedindex.site, {
      // key: key
      nokey: "true",
      strategy: "mobile"
    })
